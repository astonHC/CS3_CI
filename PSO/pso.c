...
int PSO_INIT(PSO* PSO_STATE, int DIMENSIONS, PSO_FITNESS_TYPE TYPE)
{
    ...
    {
        PSO_STATE->BOUNDS->LOWER = -100.0;
        PSO_STATE->BOUNDS->UPPER = 100.0;
    }
...
// THIS HELPS IN BEING ABLE TO LEVERAGE THE AMOUNT OF SEARCH SPACE
// FOR DEFINING A DIMENSION

void PSO_SET_BOUNDS(PSO* STATE, int DIMENSION, double LOWER, double UPPER)
{
    if(!PSO_VALID_DIMENSIONS(DIMENSION, STATE->DIMENSIONS))
    {
